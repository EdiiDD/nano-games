...
class NGServerManager {
    ...
    // the currentPlayer is registered
    ...
    // The currentPlayer is removed from the list
    public synchronized void removePlayer(NGPlayerInfo player) {
        this.players.remove(player.getNick());
    }

    // A currentPlayer request to enter in a room. If the access is granted the RoomManager
    // is returned
    ...
    // A currentPlayer leaves the room
